...
module.exports = class LearningGoals1 extends Component {
    ...
    render() {
        return (
            ...
            Describe tools like Babel, WebPack and create-react-app and how the fit in tointo the React-world
            ...
            Explain what is required to use  react-router with a create-react-app project buildt from scratch
